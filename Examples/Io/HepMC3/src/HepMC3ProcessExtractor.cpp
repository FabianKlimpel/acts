...
ActsExamples::HepMC3ProcessExtractor::~HepMC3ProcessExtractor() {}

ActsExamples::HepMC3ProcessExtractor::HepMC3ProcessExtractor(
    ActsExamples::HepMC3ProcessExtractor::Config cfg, Acts::Logging::Level level)
    : ActsExamples::BareAlgorithm("HepMC3ProcessExtractor", level),
      m_cfg(std::move(cfg)) {
...
ActsExamples::ProcessCode ActsExamples::HepMC3ProcessExtractor::execute(
...
ActsExamples::HepMC3ProcessExtractor::execute(const AlgorithmContext& context, const std::vector<HepMC3::GenEvent>& events) const {
